...
const asterixValidator = (value: unknown) => {
    ...
    if (counter% 2!== 0) {return "Number of * should be even"}
    return true
}
        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    required: true,
                    admin: {
                        description: "surround the work you want highlighted in red with **"
                    },
                ...
                },
                {
                    ...
                    required: true,
                    validate: asterixValidator,
                    defaultValue: "Empowering the next generation of builders, thinkers, and leaders through *hands-on learning* and *global collaboration*",
                    admin: {
                        description: "surround the work you want highlighted in red with **"
                    }
